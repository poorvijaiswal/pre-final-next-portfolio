...
import HomePC from '@/portmodels/HomePC'
  ...
  return (
    <>
      <main className="flex max-h-screen flex-col items-center justify-between relative">
        ...
        <div className="md:absolute md:top-1/3 z-50 min-w-80 md:right-2 -translate-y-1/2 bg-transparent p-4 hidden md:block lg:left-[680px] xl:left-[880px]">
          <div className="py-6">
            <span className=" py-4 text-2xl lg:text-3xl tracking-wide md:text-2xl">HELLO WORLD!!</span>
            <span className="blog-title-emoji text-2xl lg:text-3xl md:text-2xl py-4">👋</span><br />
          </div>
          <div className='mt-4'>
            ...
            <span><Link href={'/about'} className="tracking-wide cursor-pointer py-4 text-4xl md:text-3xl text-color-brand-orange font-extrabold">Poorvi Jaiswal</Link></span>
          </div>
          <div>
      ...
      <div className=" w-full h-52 min-w-80 bg-transparent p-4 block md:hidden text-center mb-8">
        <div className='mt-4'>
          ...
          <span><Link href={'/about'} className="tracking-wide cursor-pointer py-4 text-3xl md:text-3xl text-color-brand-orange font-extrabold">Poorvi Jaiswal</Link></span>
        </div>
        <div>

...
const Timer = (props: TimerProps) => {
    ...
    return <div>
        {showTimer ? (
            <div className='flex items-center space-x-2 bg-color-dark-fill-3 p-1.5 cursor-pointer rounded hover:bg-color-dark-fill-2'>
            ...
            <div className='flex items-center p-1 h-8 rounded hover:bg-color-dark-fill-3 cursor-pointer' onClick={() => setShowTimer(true)}>
                <svg

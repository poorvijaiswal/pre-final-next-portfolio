                ...
                <div className='px-5'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex items-center mt-3'>
                            ...
                            <div
                                className='flex items-center cursor-pointer hover:bg-color-dark-fill-3 space-x-1 rounded p-[3px]  ml-4 text-lg transition-colors duration-200 text-green-s text-color-dark-gray-6'
                            ...
                            <div
                                className='cursor-pointer hover:bg-dark-fill-3  rounded p-[3px]  ml-4 text-xl transition-colors duration-200 text-color-green-s text-color-dark-gray-6 '
                            // onClick={handleStar}
                            >
                                <AiFillStar />
